...
customer1 = BankAccount('홍길동', '123-456-789', 100000)
customer2 = BankAccount('신사임당', '987-654-321', 500000)

customer1.print_account_info()
print()
customer2.print_account_info()
print()
